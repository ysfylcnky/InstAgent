...
const FIELD_META = {
    ...
    PANEL_EMAIL:              { label: "Panel E-postası", help: "Panele bu e-posta ile girersiniz. Yalnız sizin mağazanıza aittir.", ph: "ad@magazam.com" },
    PANEL_PASSWORD:           { label: "Panel Parolası", help: "En az 8 karakter. Boş bırakırsanız mevcut parola korunur." },
